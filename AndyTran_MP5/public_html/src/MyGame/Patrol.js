...
Patrol.prototype.initialize = function () {
    ...
    this.setupSpriteTransform(cameraPos, cameraWidth);
...
Patrol.prototype.setupAnimation = function () {
...
Patrol.prototype.setupInterpolation = function () {
...
Patrol.prototype.setupSpriteTransform = function (cameraPos, cameraWidth) {
    //Patrol always spawns in random location on the right half of screen
    //bounded between the top and bottom 25%
...
Patrol.prototype.checkTermination = function () {
    if ((this.head.getXform().getXPos() - this.head.getXform().getWidth() / 2) 
            ...
            MyGame.mMainCamera.getWCWidth() / 2) || this.wingOne.getColor()[3] 
            >= 1.0 || this.wingTwo.getColor()[3] >= 1.0)
    {
        this.head = null;
        this.wingOne = null;
        this.wingTwo = null;
